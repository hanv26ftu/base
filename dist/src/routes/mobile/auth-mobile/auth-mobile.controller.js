...
exports.AuthMobileController = void 0;
...
let AuthMobileController = class AuthMobileController {
...
], AuthMobileController.prototype, "register", null);
__decorate([
    common_1.Post('login'),
    __param(0, common_1.Response()), __param(1, common_1.Body()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], AuthMobileController.prototype, "login", null);
AuthMobileController = __decorate([
    swagger_1.ApiTags('auth'),
    common_1.Controller('auth'),
    __metadata("design:paramtypes", [auth_mobile_service_1.AuthMobileService])
], AuthMobileController);
exports.AuthMobileController = AuthMobileController;
